...
This project is indexed by GitNexus as **main-awf** (8787 symbols, 24335 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
